...
class FinalBlock(nn.Module):
    ...
    def __init__(self, in_ch, pool_size, h_channel):
        ...
        self.tennis_mask_out = nn.Conv2d(in_ch, 2, 1)
    ...
    def forward(self, x):
        ...
        tennis_mask = torch.nn.Softmax(1)(self.tennis_mask_out(x))
...
class ShallowNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.layers(x)
        return self.height(x), self.weight(x)
